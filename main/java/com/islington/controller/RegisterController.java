...
public class RegisterController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            if (isAdded == null) {
                ...
                Cookie userCookie = new Cookie("username", URLEncoder.encode(userModel.getUsername(), StandardCharsets.UTF_8));
    ...
    private UserModel extractUserModel(HttpServletRequest req) {
        ...
        String username = req.getParameter("username");
        String email = req.getParameter("email");
        String phone = req.getParameter("phoneNumber").replaceAll("[^\\d]", "");
        String password = req.getParameter("password");
        String gender = req.getParameter("gender");

        return new UserModel(0, firstName, lastName, username, email, gender, phone, password);
    }
